    ...
    >
      ...
      >
        <div className="pl-12 md:pl-20 lg:pl-28" style={{ maxWidth: '42%', minWidth: 320 }}>
          ...
          <div
            className="mt-4 inline-flex items-center gap-2 whitespace-nowrap rounded-full bg-[#d8d2c9]/90 px-4 py-2 text-[9px] text-[#2a221c] shadow-[0_4px_16px_rgba(28,22,18,0.12)]"
